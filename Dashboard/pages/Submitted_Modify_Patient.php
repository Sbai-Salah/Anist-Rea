      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Modifier Patient</li>
          </ol>
          <h6 class="font-weight-bolder mb-0">Modifier Patients</h6>
        </nav>
          ...
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                <h6 class="text-white text-capitalize ps-3">Modifier un Patient</h6>
              </div>
            </div>
              ...
              <div class="table-responsive p-0">
                ...
                <div id="stage" class="form-all">
                    <div class="thankyou-wrapper">
                        ...
                        <h1 class="thankyou-main-text ty-text" style="text-align:center;">Patient Modifié !</h1>
                        <p class="thankyou-sub-text ty-text" style="text-align:center;">Votre patient a été modifié avec Succès.</p>
                        </div>
                    </div>
                    ...
                    <div class="card-body p-3">
                        <div class="row rowButton">
                            ...
                            <?php
                            echo '<a class="btn bg-gradient-success w-100 mb-0 toast-btn" href="Modifier_patient.php?id='.$_GET["id"].'" data-target="successToast">Modifier</a>';
                            ?>
                            </div>
