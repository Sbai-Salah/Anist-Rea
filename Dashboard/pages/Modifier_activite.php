...
if( isset($_POST["Modifier"]) ){
    ...
    $activiteQuery = "UPDATE activites SET activite='$activite',centre='$centre',dateDebut='$dateDebut',dateFin='$dateFin',organisateur='$organisateur',organisation='$organisation',telephone='$telephone',statutActivite='$statutActivite',progression='$progression',description='$description' WHERE id_activite=$id_activite";
    ...
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" navbar-scroll="true">
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          ...
          <h6 class="font-weight-bolder mb-0">Modifier Activité</h6>
        </nav>
          ...
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                <h6 class="text-white text-capitalize ps-3">Modifier Une Activité</h6>
              </div>
            </div>
            <div class="card-body px-0 pb-2">
              ...
              <form class="jotform-form" action="" method="post" name="ModifierActivité" id="221017784288562" accept-charset="utf-8" autocomplete="on">
                ...
                <div role="main" class="form-all">
                    <ul class="form-section page-section">
                      ...
                      <?php
                        $id_activite = $_GET["id_activite"];
                        $sqlRequest = "SELECT * FROM activites WHERE id_activite=$id_activite";
                      ...
                      <li class="form-line form-line-column form-col-2" data-type="control_textbox" id="activite">
                          ...
                          <div id="activite" class="form-input-wide" data-layout="half">
                            <input type="text" placeholder="activité" id="activite" name="activite" data-type="input-textbox" class="form-textbox" style="width:100%" value="<?php if(mysqli_num_rows($sqlResult)>0){echo $Activite;}else{echo "";}?>"/>
                          </div>
                      </li>
                      ...
                      <li class="form-line form-line-column form-col-2" data-type="control_textbox" id="id_13">
                          ...
                          <div id="cid_13" class="form-input-wide" data-layout="half">
                            <input type="text" placeholder="centre" id="centre" name="centre" data-type="input-textbox" class="form-textbox" style="width:100%" value="<?php if(mysqli_num_rows($sqlResult)>0){echo $Centre;}else{echo "";}?>"/>
                          </div>
                      </li>
                      ...
                      <li class="form-line form-line-column form-col-3" data-type="control_datetime" id="dateDebut">
                          ...
                          <div id="cid_8" class="form-input-wide" data-layout="half">
                            <div data-wrapper-react="true">
                                ...
                                <input type="text" name="dateDebut" value="<?php if(mysqli_num_rows($sqlResult)>0){echo $DateDebut;}else{echo "";}?>" class="form-textbox validate[limitDate, validateLiteDate]" id="dateDebut" size="12" data-maxlength="12" maxLength="12" data-age="" value="" data-format="yyyymmdd" data-seperator="-" placeholder="YYYY-MM-DD" autoComplete="section-input_8 off" aria-labelledby="label_8 sublabel_8_litemode" required/>
                      ...
                      <li class="form-line form-line-column form-col-3" data-type="control_datetime" id="dateFin">
                          ...
                          <div id="cid_8" class="form-input-wide" data-layout="half">
                            <div data-wrapper-react="true">
                                <span class="form-sub-label-container" style="vertical-align:top">
                                <input type="text" name="dateFin" value="<?php if(mysqli_num_rows($sqlResult)>0){echo $DateFin;}else{echo "";}?>" class="form-textbox validate[limitDate, validateLiteDate]" id="dateFin" size="12" data-maxlength="12" maxLength="12" data-age="" value="" data-format="yyyymmdd" data-seperator="-" placeholder="YYYY-MM-DD" autoComplete="section-input_8 off" aria-labelledby="label_8 sublabel_8_litemode" required/>
                                <img class="newDefaultTheme-dateIcon icon-liteMode" alt="Pick a Date" id="input_8_pick" src="https://cdn.jotfor.ms/images/calendar.png" data-component="datetime" aria-hidden="true" data-allow-time="No" data-version="v2" />
                      ...
                      <li class="form-line" data-type="control_radio" id="id_23">
                          ...
                          <div id="cid_23" class="form-input-wide" data-layout="full">
                            <div class="form-single-column" role="group" aria-labelledby="label_23" data-component="radio">
                                ...
                                <input type="radio" name="organisateur" aria-describedby="label_23" class="form-radio" id="input_23_0" value="Hopital publique" <?php if(mysqli_num_rows($sqlResult)>0 && $Organisateur=="Hopital publique"){echo "checked";}?>/>
                                <label id="label_input_23_0" for="input_23_0"> Hopital publique </label>
                                </span>
                                <span class="form-radio-item" style="clear:left">
                                <span class="dragger-item">
                                </span>
                                <input type="radio" name="organisateur" aria-describedby="label_23" class="form-radio" id="input_23_1" value="Hopital privé" <?php if(mysqli_num_rows($sqlResult)>0 && $Organisateur=="Hopital privé"){echo "checked";}?>/>
                                <label id="label_input_23_1" for="input_23_1"> Hopital privé </label>
                                </span>
                                <span class="form-radio-item" style="clear:left">
                                <span class="dragger-item">
                                </span>
                                <input type="radio" name="organisateur" aria-describedby="label_23" class="form-radio" id="input_23_2" value="Association caritative" <?php if(mysqli_num_rows($sqlResult)>0 && $Organisateur=="Association caritative"){echo "checked";}?>/>
                                <label id="label_input_23_2" for="input_23_2"> Association caritative  </label> 
                                </span>
                                <span class="form-radio-item" style="clear:left">
                                <span class="dragger-item">
                                </span>
                                <input type="radio" name="organisateur" aria-describedby="label_23" class="form-radio" id="input_23_3" value="Autre" <?php if(mysqli_num_rows($sqlResult)>0 && $Organisateur=="Autre"){echo "checked";}?>/>
                      ...
                      <li class="form-line form-line-column form-col-2" data-type="control_textbox" id="activite">
                          ...
                          <div id="organisation" class="form-input-wide" data-layout="half">
                            <input type="text" id="organisation" name="organisation" placeholder="Organisation" data-type="input-textbox" class="form-textbox" style="width:100%" value="<?php if(mysqli_num_rows($sqlResult)>0){echo $Organisation;}else{echo "";}?>"/>
                          </div>
                      </li>
                      ...
                      <li class="form-line" data-type="control_radio" id="id_23">
                          ...
                          <div id="cid_23" class="form-input-wide" data-layout="full">
                            <div class="form-single-column" role="group" data-component="radio">
                                ...
                                <input type="radio" id="statut1" name="statutActivite" class="form-radio" value="En Travail" <?php if(mysqli_num_rows($sqlResult)>0 && $StatutActivite=="En Travail"){echo "checked";}?>/>
                                <label for="statut1"> En Travail </label>
                                </span>
                                <span class="form-radio-item" style="clear:left">
                                <span class="dragger-item">
                                </span>
                                <input type="radio" id="statut2" name="statutActivite" class="form-radio" value="Finie" <?php if(mysqli_num_rows($sqlResult)>0 && $StatutActivite=="Finie"){echo "checked";}?>/>
                                <label for="statut2"> Finie </label>
                                </span>
                                <span class="form-radio-item" style="clear:left">
                                <span class="dragger-item">
                                </span>
                                <input type="radio" id="statut3" name="statutActivite" class="form-radio" value="Annulée" <?php if(mysqli_num_rows($sqlResult)>0 && $StatutActivite=="Annulée"){echo "checked";}?>/>
                      ...
                      <label class="form-label form-label-top" id="progression" for="progression"> Progression d'activité </label>
                          <div id="cid_13" class="form-input-wide">
                            <input type="range" id="progression" name="progression" value="<?php if(mysqli_num_rows($sqlResult)>0){echo $Progression;}else{echo "";}?>" min="0" max="100" step="10" class="form-textbox" style="width:70%;" size="310" value=""/>
                          </div>
                      ...
                      <label class="form-label form-label-top form-label-auto" id="description" for="description"> Description d'activité </label>
                        <div id="cid_15" class="form-input-wide" data-layout="full">
                          <span class="form-sub-label-container" style="vertical-align:top">
                            <textarea id="description" class="form-textarea" name="description" style="width:648px;height:120px" data-component="textarea" aria-labelledby="label_15 sublabel_input_15"><?php if(mysqli_num_rows($sqlResult)>0){echo $Description;}else{echo "";}?></textarea>
                      ...
                      <li class="form-line" data-type="control_button" id="id_2">
                          <div id="cid_2" class="form-input-wide" data-layout="full">
                            <div data-align="auto" class="form-buttons-wrapper form-buttons-auto   jsTest-button-wrapperField">
                                <button id="input_2" type="submit" name="Modifier" class="form-submit-button form-submit-button-book_blue2 submit-button jf-form-buttons jsTest-submitField" data-component="button" data-content="">
                                Modifier
                                </button>
                            </div>
                          </div>
